...
router.get('/:id/:groupId', asyncHandler(async (req, res) => {
...
router.get('/:id/create-group', csrfProtection, asyncHandler(async (req, res) => {
...
router.get('/:id/:groupId/add-member', csrfProtection, asyncHandler(async (req, res) => {
...
router.post('/:id/create-group', csrfProtection, groupValidators,
...
router.post('/:id/:groupId/add-member', memberValidators, asyncHandler(async (req, res) => {
...
router.post('/:id/:groupId/delete-group', asyncHandler(async (req, res) => {
    const groupId = parseInt(req.params.groupId, 10);
...
router.post('/:id/:groupId/leave-group', asyncHandler(async (req, res) => {
    const groupId = parseInt(req.params.groupId, 10);
    const userId = parseInt(req.params.id, 10);
